...
let revealRadius = 10; // Начальный радиус видимой области (в %)
const maxRadius = 100; // Максимальный радиус (полностью видимое изображение)
const step = 20; // Шаг увеличения радиуса
...
const correctAnswer = "Spider-Man"; // Правильный ответ
...
submitButton.addEventListener("click", () => {
    ...
    if (userAnswer.toLowerCase() === correctAnswer.toLowerCase()) {
        ...
        setTimeout(() => {
            ...
            congratText.textContent = "Fantastic!";
